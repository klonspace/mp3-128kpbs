  ...
  <div class="home">
    <div class="inputContainer">
      ...
      <div
        class="overlay"
        v-html="placeholder"
        :class="{'error' : errorWithURL, 'loading': checkingURL}"
      ></div>
    </div>
      ...
      <ul>
        <div v-for="(song, i) in $store.state.songs" :key="song.url+i">
          <div :data-id="song.id" class="song">
            ...
            <div class="textPartContainer">
              <div class="textBlocks">
                <div class="block">
                  <div class="blockTitle">ARTIST</div>
                  <div
                    v-html="song.artist"
                    spellcheck="false"
                    data-fontsize="1"
                ...
                <div class="block">
                  <div class="blockTitle">TRACK</div>
                  <div
                    v-html="song.title"
                    spellcheck="false"
                    data-fontsize="1"
          ...
          <div class="loadingBar">
            <div class="loadedPart" :style="loaded(i)" data-currwidth="0"></div>
          </div>
        </div>
      </ul>
    </div>
  ...
  methods: {
    progressSmooth() {
      ...
      this.$store.state.songs.forEach((song, i) => {
        song.smoothProgress +=
          (song.downloadProgress - song.smoothProgress) / 20;
      });
    },
    pasteURL(e) {
      console.log(e);
